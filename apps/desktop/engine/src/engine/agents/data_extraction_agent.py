...
Runs on OpenAI today. TODO(llama.cpp): swap the provider here for an
on-device model once local-model download/management is built -- everything
else in this module (prompt, agent wiring, output schema) can stay as-is.
"""
