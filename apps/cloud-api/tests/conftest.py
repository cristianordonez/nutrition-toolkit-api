...
if typing.TYPE_CHECKING:
    ...
    from api.models.sql.api_key import APIKey, Permission
...
def load_controller_module(
    ...
    db_module: typing.Any = types.ModuleType("api.database.db")
    db_module.get_session = lambda: iter([object()])
    db_module.engine = object()
    monkeypatch.setitem(sys.modules, "api.database.db", db_module)
...
def patch_key_controller_dependencies(
    ...
    def _patch(
        ...
        *,
        ...
        from api.controllers.key import base  # noqa: PLC0415
