...
from ntk.models.extracted_fact_create import ExtractedFactCreate, KnowledgeChunkPayload
...
class KnowledgeExtractor(BaseExtractor):
    ...
    async def extract(self) -> list[ExtractedFactCreate]:
        """Extract searchable knowledge chunks as transient facts."""
        return [
            ...
            for index, chunk in enumerate(sliding_window(self._document_text))
        ]
